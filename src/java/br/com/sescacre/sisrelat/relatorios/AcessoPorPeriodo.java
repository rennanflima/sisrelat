...
@ManagedBean
@RequestScoped
public class AcessoPorPeriodo implements Serializable {
    ...
    public void gerarRelatorioWeb() {
        ...
        String arquivo = context.getRealPath("WEB-INF/relatorios/controleAcessoPorPeriodo.jasper");
        ...
        ResultSet rs = pactoDao.acessoPorPeriodo(conn, new java.sql.Date(dtInicio.getTime()), new java.sql.Date(dtTermino.getTime()));
